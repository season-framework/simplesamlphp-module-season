 ...
 * @return void
 */
function season_hook_seasoninject(&$hookinfo)
{
    ...
    $portal = new \SimpleSAML\Module\season\Portal($allLinks, $pagesets);
    ...
    // Header
    $hookinfo['pre'][] = '<div id="portalmenu" class="ui-tabs ui-widget ui-widget-content ui-corner-all">' . $portal->getMenu($hookinfo['page']) . '</div>';
}
