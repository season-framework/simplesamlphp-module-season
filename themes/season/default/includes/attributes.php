...
function present_attributes(\SimpleSAML\XHTML\Template $t, $attributes, $nameParent)
{
    ...
    $str = (strlen($nameParent) > 0) ? '<table class="table table-vcenter"' :
        '<table id="table_with_attributes" class="table table-vcenter" summary="attribute overview">';
    ...
    foreach ($attributes as $name => $value) {
        ...
        if (preg_match('/^child_/', $nameraw)) {
            ...
            if (sizeof($value) > 1) {
                ...
                $str .= '</td><td style="width: 120px;"><code style="margin: 0;">' . htmlspecialchars($nameraw) . '</code>';
